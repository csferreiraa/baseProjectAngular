...
export class InMemoryDatabase implements InMemoryDbService {
    ...
    createDb() {
        const categories: Category[] = [
            ...
            { id: 6, name: 'Teste', description: 'Deleção' }
        ];
        ...
        const entries: Entry[] = [
            ...
            { id: 56, name: 'Cleiton', categoryId: categories[1].id, category: categories[1], paid: false, date: "28/11/2018", amount: "30,00", type: "expense" } as Entry
        ]
